...
ge.create = function (tag) {
    "use strict";
    return document.createElement(tag);
};
ge.copyObject = function (o1, o2) {
    "use strict";
    for (var attr in o1) {
        o2[attr] = o1[attr];
    }
};
ge.mergeObject = function (o1, o2) {
    "use strict";
    for (var attr in o1) {
...
(function () {
    ...
    var functionUsesSuper = /abc/.test(function () {
        abc();
    }) ? /\b_super\b/ : /.*/;
...
ge.default_options = {
    ...
    }, // Handler called after each move
    drawHandler: function (ctx, state, sprites) {
    }, // Handler called after each draw
    ...
    ceilingImage: undefined, // Sky texture
    ceilingSolidColor: undefined, // Ceiling solid color
