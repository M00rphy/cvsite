...
if (isset($_FILES["nuevaFoto"]["tmp_name"])) {
    ...
    if ($_FILES["nuevaFoto"]["type"] == "image/jpeg") {
        ...
        $ruta = "../foto/" . $matricula . "-" . $id . "-Foto" . ".jpg";
        $rutam = "foto/" . $matricula . "-" . $id . "-Foto" . ".jpg";
    ...
    if ($_FILES["nuevaFoto"]["type"] == "image/png") {
        ...
        $ruta = "../foto/" . $matricula . "-" . $id . "-Foto" . ".png";

        $rutam = "foto/" . $matricula . "-" . $id . "-Foto" . ".png";
