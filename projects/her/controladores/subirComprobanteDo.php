...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_FILES['ebook']['error'] !== 0) {
        ...
        if (
            ...
            $ruta_ebook = '../compDomicilio/' . $expediente . '-' . $usuario . '.pdf';

            $ruta = '/compDomicilio/' . $expediente . '-' . $usuario . '.pdf';

            if (move_uploaded_file($ebook, $ruta_ebook)) {


                $consultaDocumento = "INSERT INTO comprobantes (expediente, usuario,  ruta,  idTipoParticipacion )
