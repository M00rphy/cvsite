...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_FILES['ebook']['error'] !== 0) {
        ...
        if (
            ...
            $ruta_ebook = '../poderes/' . $expediente . '-' . $usuario . '.pdf';

            $ruta = '/poderes/' . $expediente . '-' . $usuario . '.pdf';

            if (move_uploaded_file($ebook, $ruta_ebook)) {


                $consultaDocumento = "INSERT INTO poderes (expediente, usuario,  ruta,  idTipoParticipacion )
