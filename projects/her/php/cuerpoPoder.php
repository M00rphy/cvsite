...
$consultaR = "SELECT * FROM poderes WHERE expediente='$expedienteP' AND usuario ='$usuario'";
        ...
        <div class="col-12">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td> Poder del representante Legal

                        <div>


                            <form action="../controladores/subirpoder.php" method="POST" enctype="multipart/form-data">
