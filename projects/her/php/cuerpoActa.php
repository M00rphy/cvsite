...
$consultaR = "SELECT * FROM actas WHERE expediente='$expedienteP' AND usuario ='$usuario'";
                ...
                <tr>
                    ...
                    <td> Acta Constitutiva
                        ...
                        <div>
                            ...
                            <form action="../controladores/subirActa.php" method="POST" enctype="multipart/form-data">
