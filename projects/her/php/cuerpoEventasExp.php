        ...
        <div class="col-10">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="buscadorInvitaciones.php?expediente=<?php echo $expedienteP ?>&participacion=A&paginacion=1"
                            class="btn btn-success">Arrendador(es)</a>
                    </td>
                    <td align="center">
                        <a href="buscadorInvitaciones.php?expediente=<?php echo $expedienteP ?>&participacion=Ao&paginacion=1"
                            class="btn btn-success">Arrendatario(es)</a>
                    </td>
                    <td align="center">
                        <a href="buscadorInvitaciones.php?expediente=<?php echo $expedienteP ?>&participacion=Fi&paginacion=1"
